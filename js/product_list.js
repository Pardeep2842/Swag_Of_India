...
let productListUrl = 'https://my-json-server.typicode.com/Pardeep2842/Swag_of_India-Product_list_page-Products_data/db';
let productList;
let cards = "";
let reviews = "";
let lowStar = 0;
                ...
                cards = `<div class="col-lg-4 col-md-6 col-12 card-container pad-sm-card pad-left-right-5">
                                    <div class="card mb-4 shadow-sm d-flex align-items-center justify-content-center"
                                        ...
                                        <div class="product-img">
                                            <img src="images/${product.source}.png" alt="${product.imageName}" role="img"
                                                aria-label="product-image">
                                        </div>
                                        <div class="product-view">
                                            <div class="row">
                                                <div class="col-4 wishlist" onclick="wishlist.addToWishlist('${encodeURI(JSON.stringify(product))}')"><img src="images/Group 2579.png" alt="wishlist"></div>
                                                <div class="col-4 view" onclick="productView.addToProductView('${encodeURI(JSON.stringify(product))}')"><a href="./product_view.html"><img src="images/Group 2580.png" alt="view"></a></div>
                                                <div class="col-4 cart" onclick="cart.addToCart('${encodeURI(JSON.stringify(product))}')"><img src="images/Group 2581.png" alt="cart"></div>
                                            </div>
                                        </div>
                                        <div class="card-body card-box">
                                            <h6>${product.name}</h6>
                                            <div class="product-cost"><span>Rs ${product.priceAfterDiscount} </span><span>Rs${product.price}</span><span>
                                                    (${product.offers}
                                                    Off)</span></div>
                                            <div class="ratings">
                                                <ul>`;
