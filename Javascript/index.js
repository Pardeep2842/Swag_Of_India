...
function changeFunc() {
  ...
  if (selectedValue == 'India') {
    ...
    document.getElementById('ph-number').innerHTML = '+91 7988836295';
  } else if (selectedValue == 'UK') {
    document.getElementById('flag-icon').src = 'Images/UK-flag.png';
    document.getElementById('ph-number').innerHTML = '+44 4444 555555';
  } else if (selectedValue == 'Canada') {
    document.getElementById('flag-icon').src = 'Images/canada-flag.png';
    document.getElementById('ph-number').innerHTML = '+1 111 222 3333';
  } else {
    document.getElementById('flag-icon').src = 'Images/german-flag.png';
    document.getElementById('ph-number').innerHTML = '+49-444-999-999';
  };
}
...
window.onload = function () {
  ...
  document.getElementById('profileInputEmail1').value = 'pardeepkumar2842@gmail.com';
  }
  else{
